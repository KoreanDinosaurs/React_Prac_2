                    ...
                    <Container num={completeNum} key={i}>
                        ...
                        <Wrap num={completeNum}>
                            <button onClick={click_btn} data-id={i}> 
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.2" baseProfile="tiny" viewBox="0 0 21 21" height="1.5em" width="2.2em" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.2" baseProfile="tiny" viewBox="0 0 24 24" completed="true" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
